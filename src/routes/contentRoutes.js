...
// const DASHBOARD = {
// 	HOME: lazy(() => import('../pages/Portal/Requirements/index')),
// };
...
const PURCHASE = {
	PURCHASEORDER: lazy(() => import('../pages/allModules/purchase/purchaseOrder/index')),
	ADJUSTINVENTORY: lazy(() => import('../pages/allModules/purchase/adjustInventory/index')),
	RETURN: lazy(() => import('../pages/allModules/purchase/returnPurchase/index')),
	STOCK: lazy(() => import('../pages/allModules/purchase/inventory/index')),
	EXPIREDSTOCK: lazy(() => import('../pages/allModules/purchase/expiredStock/index')),
	STOCKREPORT: lazy(() => import('../pages/allModules/purchase/stockReport/index')),
	EXPOSEDSTOCK: lazy(() => import('../pages/allModules/purchase/exposedStock/index')),
};
const SALEPURCHASE = {
	SALEPURCHASEORDER: lazy(() => import('../pages/allModules/sale/salePurchase/index')),
	SALEORDER: lazy(() => import('../pages/allModules/sale/saleOrder/index')),
	QUOTATION: lazy(() => import('../pages/allModules/sale/quotation/index')),
	RETURN: lazy(() => import('../pages/allModules/sale/return/index')),
};
const REPORTS = {
	REPORT: lazy(() => import('../pages/allModules/reportsModule/reports/index')),
	SALEREPORT: lazy(() => import('../pages/allModules/reportsModule/saleReport/index')),
	CUSTSALEREPORT: lazy(() => import('../pages/allModules/reportsModule/customerwise/index')),
	CUSTRECEIVABLE: lazy(() => import('../pages/allModules/reportsModule/customerReceivable/index')),
	SUPPLIERPAYABLE: lazy(() => import('../pages/allModules/reportsModule/supplierPayable/index')),
	MANUREPORT: lazy(() => import('../pages/allModules/reportsModule/manufactureReports/index')),
	REPRESENT: lazy(() => import('../pages/allModules/reportsModule/salesRepresent/index')),
	PSUPPLIER: lazy(() => import('../pages/allModules/reportsModule/purchaseSupplier/index')),
};
const FILES = {
	PDF: lazy(() => import('../pages/allModules/files/allpdf/index')),
};

const ITEMSCOMPONENTS = {
	CATEGORY: lazy(() => import('../pages/allModules/itemsManagement/category/index')),
	STRENGTH: lazy(() => import('../pages/allModules/itemsManagement/strength/index')),
	SUBCATEGORY: lazy(() => import('../pages/allModules/itemsManagement/subcategory/index')),
	ITEMPARTS: lazy(() => import('../pages/allModules/itemsManagement/itemParts/index')),
	ITEMRATES: lazy(() => import('../pages/allModules/itemsManagement/itemRates/index')),
};
const STORECOMPONENTS = {
	STORE: lazy(() => import('../pages/allModules/storeManagement/store/index')),
};
const PERSONCOMPONENTS = {
	PERSON: lazy(() => import('../pages/allModules/personManagement/person/index')),
};
const ACCOUNTCOMPONENTS = {
	ACCOUNT: lazy(() => import('../pages/allModules/accounts/manageAccounts/index')),
	...
	OTHERVOUCHERS: lazy(() => import('../pages/allModules/accounts/otherVouchers/index')),
	DAILYCLOSING: lazy(() => import('../pages/allModules/accounts/dailyClosing/index')),

	LOCKFINYEAR: lazy(() => import('../pages/allModules/accounts/closingFinYear/index')),
};
const PORTAL = {
	MAIN: lazy(() => import('../pages/Portal/Requirements/index')),
};
const DASHBOARD = {
...
const purchaseRoutes = [
	{
		path: purchaseModule.purchase.subMenu.purchaseOrder.path,
		element: <PURCHASE.PURCHASEORDER />,
		exact: true,
	},
	{
		path: purchaseModule.purchase.subMenu.adjustInventory.path,
		element: <PURCHASE.ADJUSTINVENTORY />,
		exact: true,
	},
	{
		path: purchaseModule.purchase.subMenu.return.path,
		element: <PURCHASE.RETURN />,
		exact: true,
	},
	{
		path: purchaseModule.purchase.subMenu.inventory.path,
		element: <PURCHASE.STOCK />,
		exact: true,
	},

	{
		path: purchaseModule.purchase.subMenu.expiredStock.path,
		element: <PURCHASE.EXPIREDSTOCK />,
		exact: true,
	},
	{
		path: purchaseModule.purchase.subMenu.stockReport.path,
		element: <PURCHASE.STOCKREPORT />,
		exact: true,
	},

	{
		path: purchaseModule.purchase.subMenu.exposedStock.path,
		element: <PURCHASE.EXPOSEDSTOCK />,
		exact: true,
	},
];
const salepurchaseRoutes = [
	{
		path: saleModule.sale.subMenu.salePurchase.path,
		element: <SALEPURCHASE.SALEPURCHASEORDER />,
		exact: true,
	},
	{
		path: saleModule.sale.subMenu.saleOrder.path,
		element: <SALEPURCHASE.SALEORDER />,
		exact: true,
	},
	{
		path: saleModule.sale.subMenu.quotation.path,
		element: <SALEPURCHASE.QUOTATION />,
		exact: true,
	},
	{
		path: saleModule.sale.subMenu.return.path,
		element: <SALEPURCHASE.RETURN />,
		exact: true,
	},
];
const pdfRoutes = [
	{
		path: pdfModule.files.subMenu.allpdf.path,
		element: <FILES.PDF />,
		exact: true,
	},
];
const reportsRoutes = [
	{
		path: reportsM.reportsModule.subMenu.reports.path,
		element: <REPORTS.REPORT />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.sale.path,
		element: <REPORTS.SALEREPORT />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.customersale.path,
		element: <REPORTS.CUSTSALEREPORT />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.customerReceivable.path,
		element: <REPORTS.CUSTRECEIVABLE />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.supplierPayable.path,
		element: <REPORTS.SUPPLIERPAYABLE />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.manufactureReports.path,
		element: <REPORTS.MANUREPORT />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.salesRepresent.path,
		element: <REPORTS.REPRESENT />,
		exact: true,
	},
	{
		path: reportsM.reportsModule.subMenu.purchaseSupplier.path,
		element: <REPORTS.PSUPPLIER />,
		exact: true,
	},
];
...
const itemRoutes = [
	{
		...
		element: <ITEMSCOMPONENTS.CATEGORY />,
		exact: true,
	},
	{
		path: itemsManagementModule.itemsManagement.subMenu.strength.path,
		element: <ITEMSCOMPONENTS.STRENGTH />,
		exact: true,
	},
	{
		path: itemsManagementModule.itemsManagement.subMenu.subcategory.path,
		element: <ITEMSCOMPONENTS.SUBCATEGORY />,
		exact: true,
	},
	{
		path: itemsManagementModule.itemsManagement.subMenu.itemParts.path,
		element: <ITEMSCOMPONENTS.ITEMPARTS />,
		exact: true,
	},
	{
		path: itemsManagementModule.itemsManagement.subMenu.itemRates.path,
		element: <ITEMSCOMPONENTS.ITEMRATES />,
		exact: true,
	},
];
const storeRoutes = [
	{
		path: storeManagementModule.storeManagement.subMenu.store.path,
		element: <STORECOMPONENTS.STORE />,
		exact: true,
	},
];
const personRoutes = [
	{
		path: personManagementModule.personManagement.subMenu.person.path,
		element: <PERSONCOMPONENTS.PERSON />,
		exact: true,
	},
];
const accountRoutes = [
	{
		path: accountManagementModule.accounts.subMenu.manageAccounts.path,
		element: <ACCOUNTCOMPONENTS.ACCOUNT />,
		exact: true,
	},
	{
		path: accountManagementModule.viewTransactions.path,
		element: <ACCOUNTCOMPONENTS.VIEWTRANSACTIONS />,
		exact: true,
	},
	{
		path: accountManagementModule.vouchers.subMenu.newTransaction.path,
		element: <ACCOUNTCOMPONENTS.NEWTRANSACTION />,
		exact: true,
	},
	{
		path: accountManagementModule.vouchers.subMenu.simpleVouchers.path,
		element: <ACCOUNTCOMPONENTS.VOUCHERS />,
		exact: true,
	},
	{
		path: accountManagementModule.vouchers.subMenu.otherVouchers.path,
		element: <ACCOUNTCOMPONENTS.OTHERVOUCHERS />,
		exact: true,
	},
	{
		path: accountManagementModule.accounts.subMenu.dailyClosing.path,
		element: <ACCOUNTCOMPONENTS.DAILYCLOSING />,
		exact: true,
	},
	// {
	// 	path: accountManagementModule.accounts.subMenu.lockFinyear.path,
	// 	element: <ACCOUNTCOMPONENTS.LOCKFINYEAR />,
	// 	exact: true,
	// },
];
const presentation = [
...
// const itemR = [...itemRoutes];

export { contents, login };
