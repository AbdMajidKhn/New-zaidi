...
// 		id: 'purchaseOrder',
// 		text: 'Purchase Order',
// 		path: `${subDir}purchase/purchaseOrder`,
// 		icon: 'check_box_outline_blank ',
// 	},
// };
...
export const purchaseModule = {
	...
	purchase: {
		id: 'purchase',
		text: 'Stock',
		path: `${subDir}purchase`,
		icon: 'list',
		subMenu: {
			purchaseOrder: {
				id: 'purchaseOrder',
				text: 'All Purchase Order',
				path: `${subDir}purchase/purchaseOrder`,
				icon: 'cart',
			},
			adjustInventory: {
				...
				path: `${subDir}inventoryModule/adjustInventory`,
				icon: 'cart',
			},
			...
			inventory: {
				id: 'inventory',
				text: 'Stock',
				path: `${subDir}inventoryModule/inventory`,
				icon: 'list',
			},
			expiredStock: {
				id: 'expiredStock',
				text: 'Expired Stock',
				path: `${subDir}inventoryModule/expiredStock`,
				icon: 'list',
			},
			stockReport: {
				id: 'stockReport',
				text: 'Stock Report',
				path: `${subDir}inventoryModule/stockReport`,
				icon: 'list',
			},
			...
			exposedStock: {
				id: 'exposedStock',
				text: 'Disposed Stock',
				path: `${subDir}inventoryModule/exposedStock`,
				icon: 'list',
			},
			return: {
				id: 'return',
				text: 'Return',
				path: `${subDir}purchase/return`,
				icon: 'ArrowLeft',
			},
		},
	},
...
export const itemsManagementModule = {
	heading: {
		id: 'itemsManagementModuleHeading',
	...
	itemsManagement: {
		...
		subMenu: {
			...
			itemRates: {
				id: 'itemRates',
				text: 'Item Rates ',
				path: `${subDir}itemsManagement/itemRates`,
				icon: 'Money',
			},
			strength: {
				id: 'strength',
				text: 'Strength',
				path: `${subDir}itemsManagement/strength`,
				icon: 'list',
			},
		},
	},
...
// 	heading: {
// 		id: 'quotationModuleHeading',
// 		text: 'Quotation Module',
// 		icon: 'Grass',
// 	},
// 	quotations: {
// 		id: 'quotations',
// 		text: 'Quotations',
// 		path: `${subDir}quotations`,
// 		icon: 'Grass',
// 		subMenu: {
// 			quotation: {
// 				id: 'quotation',
// 				text: 'quotation ',
// 				path: `${subDir}quotations/quotation`,
// 				icon: 'GridGoldenratio',
// 			},
// 		},
// 	},
	...
	sale: {
		...
		subMenu: {
			saleOrder: {
				id: 'saleOrder',
				text: 'Sale Invoices ',
				path: `${subDir}sale/saleOrder`,
				icon: 'cart',
			},
			salePurchase: {
				id: 'salePurchase',
				text: 'Sale PO',
				path: `${subDir}sale/salePurchase`,
				icon: 'list',
			},
...
export const storeManagementModule = {
	heading: {
		id: 'storeManagementModuleHeading',
		text: 'Store Module',
		icon: 'Grass',
	},
	storeManagement: {
		id: 'storeManagementModule',
		text: 'Store Management',
		path: `${subDir}storeManagement`,
		icon: 'Grass',
		subMenu: {
			store: {
				id: 'store',
				text: 'Store',
				path: `${subDir}storeManagement/store`,
				icon: 'GridGoldenratio',
			},
		},
	},
};
export const reportsM = {
	heading: {
		id: 'reportsModuleHeading',
		text: 'Reports Module',
		icon: 'report',
	},
	...
	reportsModule: {
		...
		path: `${subDir}reportsModule`,
		icon: 'report',
		subMenu: {
			reports: {
				id: 'reports',
				text: 'Purchase Reports',
				path: `${subDir}reportsModule/reports`,
				icon: 'cart',
			},
			purchaseSupplier: {
				id: 'purchaseSupplier',
				text: 'Purchase Supplier Wise Report',
				path: `${subDir}inventoryModule/purchaseSupplier`,
				icon: 'list',
			},
			sale: {
				id: 'salereports',
				text: 'Sale Reports',
				path: `${subDir}reportsModule/sale`,
				icon: 'cart',
			},
			customersale: {
				id: 'customersalereports',
				text: 'Customer Sale Reports',
				path: `${subDir}reportsModule/customersale`,
				icon: 'people',
			},
			customerReceivable: {
				id: 'customerReceivable',
				text: 'Customer Receivable Reports',
				path: `${subDir}reportsModule/customerReceivable`,
				icon: 'people',
			},
			supplierPayable: {
				id: 'supplierPayable',
				text: 'Supplier Payable Reports',
				path: `${subDir}reportsModule/supplierPayable`,
				icon: 'people',
			},
			manufactureReports: {
				id: 'manufactureReports',
				text: 'Manufacture Reports',
				path: `${subDir}reportsModule/manufactureReports`,
				icon: 'people',
			},
			salesRepresent: {
				id: 'salesRepresent',
				text: 'Sale Representative Reports',
				path: `${subDir}reportsModule/salesRepresent`,
				icon: 'people',
			},
		},
	},
...
export const accountManagementModule = {
	heading: {
		id: 'accountManagementModuleHeading',
		text: 'Account Module',
		icon: 'Grass',
	},
	accounts: {
		...
		subMenu: {
			manageAccounts: {
				...
				path: `${subDir}accounts/manageAccounts`,
				icon: 'GridGoldenratio',
			},
			dailyClosing: {
				id: 'dailyClosing',
			...
			// lockFinyear: {
			// 	id: 'lockFinyear',
			// 	text: 'Lock Financial Year',
			// 	path: `${subDir}accounts/lockFinyear`,
			// 	icon: 'Lock',
			// },
		},
	},
...
export const personManagementModule = {
	heading: {
		id: 'personManagementModuleHeading',
		text: 'Person Module',
		icon: 'People',
	},
	personManagement: {
		id: 'personManagementModule',
		text: 'Person Management',
		path: `${subDir}personManagement`,
		icon: 'People',
		subMenu: {
			person: {
				id: 'person',
				text: 'Person',
				path: `${subDir}personManagement/person`,
				icon: 'list',
			},
		},
	},
