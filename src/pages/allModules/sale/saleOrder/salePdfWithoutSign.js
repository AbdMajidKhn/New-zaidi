...
const SalePdfWithoutSign = (data1, type) => {
	console.log(data1);
	// initialize jsPDF
	...
	// rowsMain.push([
	// 	'CNIC',
	// 	`${data1.parentData.sale_type === 2 ? data1.parentData.customer.cnic : ''}`,
	// ]);
	// rowsMain.push([
	// 	'Address',
	// 	`${data1.parentData.sale_type === 2 ? data1.parentData.customer.address : ''}`,
	// ]);
	// rowsMain.push([
	// 	'NTN',
	...
	if (data1.parentData.adv_tax_percentage !== (0 || null)) {
		tableRowsIncome.push([
			...
			{
				content: `${(
					(parseFloat(data1.parentData?.total_after_gst) || 0) +
					(parseFloat(data1.parentData?.adv_tax) || 0)
	...
	doc.setFontSize(10);
	doc.setFont(undefined, 'normal');
	doc.text('E-mail.info@zaiditraders.com', 90, 85, { align: 'left' });
	doc.setFontSize(10);
	doc.setFont(undefined, 'normal');
	doc.text('National Tax No.B689409-0', 90, 95, { align: 'left' });
	doc.setFontSize(10);
	doc.setFont(undefined, 'normal');
	doc.text('Sales Tax Reg.No.3277876322952', 90, 105, { align: 'left' });
	doc.setFontSize(10);
	doc.setFont(undefined, 'normal');
	doc.text('Drug Sale License No.01-374-0177-110744D', 90, 115, { align: 'left' });
	doc.setFontSize(10);
	doc.setFont(undefined, 'normal');
...
export default SalePdfWithoutSign;
