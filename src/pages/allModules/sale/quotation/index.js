...
const Categories = () => {
	...
	const refreshTableData = () => {
		...
		apiClient
			.get(
				`/getQuotationlist?records=${store.data.quotations.quotation.perPage}&pageNo=${
					store.data.quotations.quotation.pageNo
	...
	}, [store.data.quotations.quotation.perPage, store.data.quotations.quotation.pageNo]);
