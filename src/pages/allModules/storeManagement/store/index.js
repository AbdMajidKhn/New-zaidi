...
const Categories = () => {
	...
	const refreshTableData = () => {
		...
		apiClient
			.get(
				`/getStores?records=${store.data.storeManagement.store.perPage}&pageNo=${
					store.data.storeManagement.store.pageNo
	...
	useEffect(() => {
		refreshTableData();
		apiClient.get(`/getStoreTypeDropDown`).then((response) => {
	...
	}, [store.data.storeManagement.store.perPage, store.data.storeManagement.store.pageNo]);
