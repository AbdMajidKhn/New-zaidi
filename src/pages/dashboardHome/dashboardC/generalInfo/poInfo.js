					...
					<div className='row g-4 align-items-center'>
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									<div className='fw-bold fs-3 mb-0'>{data.pending_po}</div>
						...
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									<div className='fw-bold fs-3 mb-0'>{data.unreceived_po}</div>
									<div className='text-muted mt-n2 truncate-line-1'>
										Unreceived POs
									</div>
								</div>
						...
						<div className='col-xl-6'>
							<div
								...
								<div className='flex-grow-1 ms-3'>
									<div className='fw-bold fs-3 mb-0'>{data.total_po}</div>
									<div className='text-muted mt-n2 truncate-line-1'>
										Total POs
									</div>
								</div>
